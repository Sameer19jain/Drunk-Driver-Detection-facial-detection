...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'sameerjainexpress7@gmail.com' ")
...
def TakeImages():
    ...
    serial = 0
    exists = os.path.isfile("DriverDetails\DriverDetails.csv")
    if exists:
        with open("DriverDetails\DriverDetails.csv", 'r') as csvFile1:
        ...
        with open("DriverDetails\DriverDetails.csv", 'a+') as csvFile1:
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        row = [serial, '', Id, '', name]
        with open('DriverDetails\DriverDetails.csv', 'a+') as csvFile:
...
def TrackImages():
    ...
    exists1 = os.path.isfile("DriverDetails\DriverDetails.csv")
    if exists1:
        df = pd.read_csv("DriverDetails\DriverDetails.csv")
    else:
        mess._show(title='Details Missing', message='Driver details are missing, please check!')
        cam.release()
        cv2.destroyAllWindows()
        window.destroy()
    while True:
...
window.title("Driver Registration and Recognition System")
...
message3 = tk.Label(window, text="Driver Registration and Recognition System" ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
...
clock = tk.Label(frame3,fg="#ff61e5",bg="#2d420a" ,width=45 ,height=1,font=('comic', 22, ' bold '))
...
lbl3 = tk.Label(frame1, text="",width=20  ,fg="black"  ,bg="#c79cff"  ,height=1 ,font=('comic', 17, ' bold '))
...
trackImg = tk.Button(frame1, text="Start the Ignition", command=TrackImages  ,fg="black"  ,bg="#3ffc00"  ,width=35  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold '))
